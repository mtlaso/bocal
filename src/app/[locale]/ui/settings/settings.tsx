		...
		<section className={SPACING.MD}>
			<section className={SPACING.SM}>
				...
				<div className={SPACING.SM}>
					...
					<div className="relative">
						<Input
							disabled
							className="rounded-md border border-gray-200 py-2 pl-10 outline-2 placeholder:text-gray-500"
							autoFocus
							id="email"
							value={email}
						/>
			...
			<section className={SPACING.SM}>
				...
				<form className={SPACING.MD}>
					{/* section 1 */}
					<div className="flex items-center justify-between gap-4 border border-gray-200 rounded-md p-3">
						<div className={SPACING.SM}>
